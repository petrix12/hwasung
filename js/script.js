...
$document.ready(function () {
    ...
    var regularConstraintsMessages = [
      {
        ...
        newMessage: "Este campo de texto es requerido."
      },
      {
  ...
  if (plugins.rdGoogleMaps.length) {
    $.getScript("http://maps.google.com/maps/api/js?key=AIzaSyDl0hlgOdy3UXLurZlok-tbFBb0mTxa-s8&sensor=false&libraries=geometry&v=3.7", function () {
  ...
  if (plugins.search.length || plugins.searchResults) {
    ...
    var defaultTemplate = '<h5 class="search_title"><a target="_top" href="#{href}" class="search_link">#{title}</a></h5>' +
        '<p>...#{token}...</p>' +
        '<p class="match"><em>Coincidencias: #{count}</em></p>';
  ...
  if (plugins.rdMailForm.length) {
    var i, j, k,
      msg = {
        'MF000': 'Enviado satisfactoriamente.',
